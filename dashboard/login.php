    ...
    if(!empty($user_name) && !empty($password) && !is_numeric($user_name))
    {
        ...
        if($result)
        {
            if($result && mysqli_num_rows($result)> 0)
            {
               ...
               if($user_data['password'] === $password && $user_data['isEmployee'] == true)
               {
...
<body>
    <div class="main-block">
      <div id="box">
        ...
        <div class="new">Employee Login</div>
        <label id="icon" for="name"><i class="fas fa-user"></i></label>
        <input type="text" name="user_name" id="text" placeholder="User Name" required/>
        <label id="icon" for="name"><i class="fas fa-user"></i></label>
        ...
        <p>Create an account? </p><a href="signup.php">Signup</a><br><br>
        </div>
    </div>
  </form>
  </div>

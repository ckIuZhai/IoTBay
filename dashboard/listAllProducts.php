...
<a href="productsearch.php" style="color:gray; top:180px; left: 18px; position:absolute;">Back to browsing products<br><br></a>
<?php 
  ...
  $_SESSION['doQuery'] = false;
    ...
    echo "<h1 style='text-align:left; margin-top:-40; margin-left: 200;'> ALL PRODUCTS IN CATALOGUE: </h1> <br>";
    ...
    if($result)
    {
        if($result && mysqli_num_rows($result)> 0)
        {
          ...
          while($row = $result->fetch_assoc()) {
            echo "<div> <h4>" . "<img src=" . ($row["imageLink"]) ." width='300px' height='300px' style='margin-top: 00 object-fit: fill' > <br> <br> " . 
...
<br><br><br><br>
  ...
  <br>
  <a href="productsearch.php">Return to product search page</a>
</div>
<br>
</div>

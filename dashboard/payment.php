...
<body>
    ...
    <label id="icon" for="name"><i class="fas fa-phone"></i></label>
        ...
        <option value="0" label="Select payment method ... " selected="selected">Select payment method ... </option>
            <option value="AO" label="Debit">Debit</option>
            <option value="AO" label="Credit">Credit</option>
            </optgroup>
    </select>
    <label id="icon" for="name"><i class="fas fa-user"></i></label>
        <input type="text" name="user_name" id="text" placeholder="Card Number" required/>
        <label id="icon" for="name"><i class="fas fa-user"></i></label>
        <input type="text" name="user_name" id="text" placeholder="Cvv" required/>
        <label id="icon" for="name"><i class="fas fa-user"></i></label>
        <input type="text" name="user_name" id="text" placeholder="Name on Card" required/>
    <div class="new">Verifications</div>
        <label id="icon" for="name"><i class="fas fa-user"></i></label>
